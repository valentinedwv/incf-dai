...
//		 pos1.setStringValue("1.0 1.0 1.0");
		...
		XmlObject alist= posList.set(ArrayToDirectPositionList(pointList));
		 ...
		 // ((LinearRingType)poly1exteriortttt).addNewPosList();
		 //((LinearRingType)poly1exteriortttt).setPosList(ArrayToDirectPositionList(pointList));
		 //DirectPositionListType pts1 = ring.addNewPosList();
		 //pts1.set(ArrayToDirectPositionList(pointList));
		 ////ring.setPosList(pts1);
//polygon1.setExterior( ring);
		 //DirectPositionListType pts1 = poly1exterior.addNewPosList();
		 //pts1.set(ArrayToDirectPositionList(pointList));
		// poly1exterior.setPosList(arg0)
