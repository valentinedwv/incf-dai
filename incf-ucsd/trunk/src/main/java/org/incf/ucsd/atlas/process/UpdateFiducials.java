...
public class UpdateFiducials implements Processlet {

	private static final Logger LOG = LoggerFactory
			.getLogger(UpdateFiducials.class);
...
*/
			...
			vo.setFiducialCode(dataInputHandler.getValidatedStringValue(in, "fiducialCode"));
			vo.setFiducialName(dataInputHandler.getValidatedStringValue(in, "fiducialName"));
			vo.setFiducialType(dataInputHandler.getValidatedStringValue(in, "fiducialType"));
			vo.setDerivedFrom(dataInputHandler.getValidatedStringValue(in, "derivedFrom"));

			vo.setAuthorCode(dataInputHandler.getValidatedStringValue(in, "authorCode"));
			vo.setCertaintyLevel(dataInputHandler.getValidatedStringValue(in, "certaintyLevel"));
			vo.setSrsName(dataInputHandler.getValidatedStringValue(in, "srsName"));
			vo.setDescription(dataInputHandler.getValidatedStringValue(in, "description"));
			vo.setPos(dataInputHandler.getValidatedStringValue(in, "pos"));
			
			vo.setStatus("ACTIVE");
			vo.setDateSubmitted(String.valueOf(date));
			vo.setDateUpdated(String.valueOf(date));
			
			UCSDServiceDAOImpl impl = new UCSDServiceDAOImpl();
			String status = impl.updateFiducials(vo);
...
*/
			...
			ComplexOutput complexOutput = (ComplexOutput) out
					.getParameter("UpdateFiducialsOutput");
