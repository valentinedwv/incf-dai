...
public class GetCorrelationMapByPOI implements Processlet {
	...
	public void process(ProcessletInputs in, ProcessletOutputs out,
		...
		try {
			...
			// FIXME - uncomment the below three lines after fixing the hostname
			// issue
			/*
			...
			String imageURLPrefix = "http://" + abaHostName + abaServicePath
					+ "all_" + mapType + "?correlation&";
