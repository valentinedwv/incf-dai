...
public class IncfDBUtil {
    ...
    public static void main(String[] args)throws Exception {
    	...
    	org.incf.oslo.atlas.util.PostgresDBService.URL = "jdbc:postgresql://incf-dev-local.crbs.ucsd.edu:5432/atlas-aba-db";
    	org.incf.oslo.atlas.util.PostgresDBService.USERNAME = "atlas-aba-db";
    	org.incf.oslo.atlas.util.PostgresDBService.PASSWORD = "aba4321";
