...
public class UpdateSlices implements Processlet {

	private static final Logger LOG = LoggerFactory
			.getLogger(UpdateSlices.class);
...
*/
			...
			vo.setSpaceCode(dataInputHandler.getValidatedStringValue(in, "spaceCode"));
			vo.setSlideValueOrigin(dataInputHandler.getValidatedStringValue(in, "slideValueOrigin"));
			vo.setValueDirection(dataInputHandler.getValidatedStringValue(in, "valueDirection"));
			vo.setRightDirection(dataInputHandler.getValidatedStringValue(in, "rightDirection"));
			vo.setUpDirection(dataInputHandler.getValidatedStringValue(in, "upDirection"));
			vo.setPlusX(dataInputHandler.getValidatedStringValue(in, "plusX"));
			vo.setPlusY(dataInputHandler.getValidatedStringValue(in, "plusY"));
			vo.setPlusZ(dataInputHandler.getValidatedStringValue(in, "plusZ"));
			vo.setSliceID(dataInputHandler.getValidatedStringValue(in, "sliceID"));
			vo.setSlideValue(dataInputHandler.getValidatedStringValue(in, "slideValue"));

			vo.setStatus("ACTIVE");

			UCSDServiceDAOImpl impl = new UCSDServiceDAOImpl();
			String status = impl.updateSlices(vo);
...
*/
			...
			ComplexOutput complexOutput = (ComplexOutput) out
					.getParameter("UpdateSlicesOutput");
