...
*/
	...
	public AnnotationResponseDocument completeResponse(UCSDServiceVO vo) {
		...
		while (iterator0.hasNext()) {
			vo = (UCSDServiceVO)iterator0.next(); 
			id = vo.getUniqueID();
...
*/
		...
		UCSDServiceVO vo2 = null; 

		//Delete this loop
		while (iterator1.hasNext()) {

			vo2 = (UCSDServiceVO)iterator1.next();
...
*/
	...
	UCSDServiceVO vo3 = null;
	while (iterator2.hasNext()) {

		vo3 = (UCSDServiceVO) iterator2.next();
	...
	UCSDServiceVO vo4 = null;

	while (iterator3.hasNext()) {
	
		vo4 = (UCSDServiceVO) iterator3.next();
