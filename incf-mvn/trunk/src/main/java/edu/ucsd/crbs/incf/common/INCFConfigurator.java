 ...
 * 
 */
public class INCFConfigurator {

	/** Only public access to a single instance of this class */
	public static final INCFConfigurator INSTANCE = new INCFConfigurator();
	...
	private InputStream getInputFileURL() {
		...
		"../config/incf-config-properties-development.xml");
