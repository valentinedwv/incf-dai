//$HeadURL: http://svn.wald.intevation.org/svn/deegree/deegree3/branches/3.0/deegree-core/src/main/java/org/deegree/commons/utils/log/PackageLoggingNotes.java $
/*----------------------------------------------------------------------------
 ...
 * 
 * @version $Revision: 23180 $, $Date: 2010-03-22 05:25:53 -0700 (Mon, 22 Mar 2010) $
 */
@Retention(SOURCE)
@Target(PACKAGE)
