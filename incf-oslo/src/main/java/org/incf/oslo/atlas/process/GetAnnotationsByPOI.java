...
*/
	...
	public AnnotationResponseDocument completeResponse(OsloServiceVO vo) {
		...
		OsloServiceDAOImpl daoImpl = new OsloServiceDAOImpl();
		...
		while (iterator0.hasNext()) {
			vo = (OsloServiceVO)iterator0.next(); 
			id = vo.getUniqueID();
...
*/
		...
		OsloServiceVO vo2 = null; 

		//Delete this loop
		while (iterator1.hasNext()) {

			vo2 = (OsloServiceVO)iterator1.next();
...
*/
	...
	OsloServiceVO vo3 = null;
	while (iterator2.hasNext()) {

		vo3 = (OsloServiceVO) iterator2.next();
	...
	OsloServiceVO vo4 = null;

	while (iterator3.hasNext()) {
	
		vo4 = (OsloServiceVO) iterator3.next();
