...
<wps:Capabilities service="WPS" version="1.0.0" xml:lang="en-US" 
  ...
  <ows:ServiceIdentification>
    <ows:Title>INCF Central Atlas Services</ows:Title>
    <ows:Abstract>INCF Central Atlas Services provide access to data available 
      from the various Atlas hubs.</ows:Abstract>
