...
/*
			...
			String srsName = dataInputHandler.getValidatedStringValue(in,
					"srsName");
			String sourceType = dataInputHandler.getValidatedStringValue(in,
					"sourceType");
			String sourceURL = dataInputHandler.getValidatedStringValue(in,
					"sourceURL");
			String filter = dataInputHandler.getValidatedStringValue(in,
					"filter");
			String xMin = String.valueOf(DataInputHandler.getDoubleInputValue(
					in, "xmin"));
			String xMax = String.valueOf(DataInputHandler.getDoubleInputValue(
					in, "xmax"));
			String yMin = String.valueOf(DataInputHandler.getDoubleInputValue(
					in, "yMin"));
			String yMax = String.valueOf(DataInputHandler.getDoubleInputValue(
					in, "yMax"));
*/
...
*/
			...
			String wmsURL = decodedURL
					...
					+ vo.getMinX() + "," + vo.getMinY() + "," + vo.getMaxX()
					+ "," + vo.getMaxY();
			...
			Retrieve2DImageResponseDocument document = Retrieve2DImageResponseDocument.Factory
					.newInstance();

			Retrieve2DImageResponseType imagesRes = document
					.addNewRetrieve2DImageResponse();
			/*
			 * QueryInfoType query = imagesRes.addNewQueryInfo();
			 * query.setTimeCreated(Calendar.getInstance());
			 * Utilities.addMethodNameToQueryInfo
			 * (query,"GetMap",uri.toString());
			 * 
			 * Criteria criterias = query.addNewCriteria();
			 * 
			 * InputStringType crtieria1 = (InputStringType)
			 ...
			 * 
			 * InputStringType crtieria2 = (InputStringType)
			 * criterias.addNewInput().changeType(InputStringType.type);
			 * crtieria2.setName("sourceURL"); crtieria2.setValue(sourceURL);
			 * 
			 * InputStringType crtieria3 = (InputStringType)
			 * criterias.addNewInput().changeType(InputStringType.type);
			 * crtieria3.setName("srsName");
			 * crtieria3.setValue(vo.getFromSRSCode());
			 * 
			 * InputStringType crtieria4 = (InputStringType)
			 * criterias.addNewInput().changeType(InputStringType.type);
			 * crtieria4.setName("xmin"); crtieria4.setValue(vo.getMinX());
			 * 
			 * InputStringType crtieria6 = (InputStringType)
			 * criterias.addNewInput().changeType(InputStringType.type);
			 * crtieria6.setName("xmax"); crtieria6.setValue(vo.getMaxX());
			 * 
			 * InputStringType crtieria7 = (InputStringType)
			 * criterias.addNewInput().changeType(InputStringType.type);
			 * crtieria7.setName("ymin"); crtieria7.setValue(vo.getMinY());
			 * 
			 * InputStringType crtieria8 = (InputStringType)
			 * criterias.addNewInput().changeType(InputStringType.type);
			 * crtieria8.setName("ymax"); crtieria8.setValue(vo.getMaxY());
			 */
			...
			ComplexOutput complexOutput = (ComplexOutput) out
					.getParameter("Retrieve2DImageOutput");
