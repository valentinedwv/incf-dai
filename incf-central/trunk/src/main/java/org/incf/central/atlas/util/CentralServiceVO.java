...
public class CentralServiceVO {
	...
	private String fromSRSCodeFive;
	private String fromSRSCodeSix;
	private String fromSRSCodeSeven;
	private String fromSRSCodeEight;
	private String fromSRSCodeNine;
	private String fromSRSCodeTen;
	private String fromSRSCodeEleven;
	private String fromSRSCodeTwelve;

	private String toSRSCodeOne;
	private String toSRSCodeTwo;
	private String toSRSCodeThree;
	private String toSRSCodeFour;
	private String toSRSCodeFive;
	private String toSRSCodeSix;
	private String toSRSCodeSeven;
	private String toSRSCodeEight;
	private String toSRSCodeNine;
	private String toSRSCodeTen;
	...
	public String getFromSRSCodeFive() {
		return fromSRSCodeFive;
	}

	public void setFromSRSCodeFive(String fromSRSCodeFive) {
		this.fromSRSCodeFive = fromSRSCodeFive;
	}

	public String getFromSRSCodeSix() {
		return fromSRSCodeSix;
	}

	public void setFromSRSCodeSix(String fromSRSCodeSix) {
		this.fromSRSCodeSix = fromSRSCodeSix;
	}

	public String getFromSRSCodeSeven() {
		return fromSRSCodeSeven;
	}

	public void setFromSRSCodeSeven(String fromSRSCodeSeven) {
		this.fromSRSCodeSeven = fromSRSCodeSeven;
	}

	public String getToSRSCodeFive() {
		return toSRSCodeFive;
	}

	public void setToSRSCodeFive(String toSRSCodeFive) {
		this.toSRSCodeFive = toSRSCodeFive;
	}

	public String getToSRSCodeSix() {
		return toSRSCodeSix;
	}

	public void setToSRSCodeSix(String toSRSCodeSix) {
		this.toSRSCodeSix = toSRSCodeSix;
	}

	public String getToSRSCodeSeven() {
		return toSRSCodeSeven;
	}

	public void setToSRSCodeSeven(String toSRSCodeSeven) {
		this.toSRSCodeSeven = toSRSCodeSeven;
	}

	public String getFromSRSCodeEight() {
		return fromSRSCodeEight;
	}

	public void setFromSRSCodeEight(String fromSRSCodeEight) {
		this.fromSRSCodeEight = fromSRSCodeEight;
	}

	public String getFromSRSCodeNine() {
		return fromSRSCodeNine;
	}

	public void setFromSRSCodeNine(String fromSRSCodeNine) {
		this.fromSRSCodeNine = fromSRSCodeNine;
	}

	public String getFromSRSCodeTen() {
		return fromSRSCodeTen;
	}

	public void setFromSRSCodeTen(String fromSRSCodeTen) {
		this.fromSRSCodeTen = fromSRSCodeTen;
	}

	public String getFromSRSCodeEleven() {
		return fromSRSCodeEleven;
	}

	public void setFromSRSCodeEleven(String fromSRSCodeEleven) {
		this.fromSRSCodeEleven = fromSRSCodeEleven;
	}

	public String getFromSRSCodeTwelve() {
		return fromSRSCodeTwelve;
	}

	public void setFromSRSCodeTwelve(String fromSRSCodeTwelve) {
		this.fromSRSCodeTwelve = fromSRSCodeTwelve;
	}

	public String getToSRSCodeEight() {
		return toSRSCodeEight;
	}

	public void setToSRSCodeEight(String toSRSCodeEight) {
		this.toSRSCodeEight = toSRSCodeEight;
	}

	public String getToSRSCodeNine() {
		return toSRSCodeNine;
	}

	public void setToSRSCodeNine(String toSRSCodeNine) {
		this.toSRSCodeNine = toSRSCodeNine;
	}

	public String getToSRSCodeTen() {
		return toSRSCodeTen;
	}
	...
	public String getToSRSCodeEleven() {
		return toSRSCodeEleven;
	}

	public void setToSRSCodeEleven(String toSRSCodeEleven) {
		this.toSRSCodeEleven = toSRSCodeEleven;
	}

	public String getToSRSCodeTwelve() {
		return toSRSCodeTwelve;
	}
