...
*/
	...
	public Representation represent(Variant variant) throws ResourceException {
        ...
        try { 
	        ...
	        System.out.println("X is - " + vo.getOriginalCoordinateX());
	        System.out.println("Y is - " + vo.getOriginalCoordinateY());
	        System.out.println("Z is - " + vo.getOriginalCoordinateZ());
		...
		if (completeCoordinatesString.equalsIgnoreCase("NOT SUPPORTED")) {
	        ...
	        eh.addExceptionToReport(ExceptionCode.NOT_APPLICABLE_CODE, null, 
	                new String[] { "No Such Transformation is available under UCSD Hub." });
