...
*/
	...
	public AnnotationResponseDocument completeResponse(ABAServiceVO vo) {
		...
		while (iterator0.hasNext()) {
			vo = (ABAServiceVO)iterator0.next(); 
			id = vo.getUniqueID();
...
/*		ABAServiceVO vo1 = null;
		while (dataIterator.hasNext()) {
			...
			vo1 = (ABAServiceVO)dataIterator.next();
...
*/
		...
		ABAServiceVO vo2 = null; 

		//Delete this loop
		while (iterator1.hasNext()) {

			vo2 = (ABAServiceVO)iterator1.next();
...
*/
	...
	ABAServiceVO vo3 = null;
	while (iterator2.hasNext()) {

		vo3 = (ABAServiceVO) iterator2.next();
	...
	ABAServiceVO vo4 = null;

	while (iterator3.hasNext()) {
	
		vo4 = (ABAServiceVO) iterator3.next();
