...
public class GetStructureNamesByPOI implements Processlet {
    ...
    public void process(ProcessletInputs in, ProcessletOutputs out, 
    	...
    	String webserviceHostName = config.getValue("ucsd.webservice.host.name");
    	String webservicePortNumber = config.getValue("ucsd.webservice.port.number");

		//Code for webservice client
		String endpoint = "http://"+webserviceHostName+webservicePortNumber+"/axis/services/SpatialAtlasWebservice";
