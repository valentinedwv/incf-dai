...
public class ListHubs extends BaseResouce {

	private final Logger logger = LoggerFactory.getLogger(getClass());
	
	// cached file
	private static final String RESPONSE_FILE_NAME = "/ListHubs.xml";
	
	public ListHubs(Context context, Request request, Response response) {
