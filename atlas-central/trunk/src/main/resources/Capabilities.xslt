...
<wps:Capabilities service="WPS" version="1.0.0" xml:lang="en-US" 
  ...
  <ows:ServiceIdentification>
    <ows:Title>Central Atlas Services</ows:Title>
    <ows:Abstract>Central Atlas Services provide access to data available from the central Atlas as well as the Atlas hubs.</ows:Abstract>
