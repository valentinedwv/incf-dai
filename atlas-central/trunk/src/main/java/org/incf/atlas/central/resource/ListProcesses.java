...
public class ListProcesses extends BaseResouce {

	private final Logger logger = LoggerFactory.getLogger(getClass());
	
	// cached file
	private static final String RESPONSE_FILE_NAME = "/ListProcesses.xml";
	
	public ListProcesses(Context context, Request request, Response response) {
