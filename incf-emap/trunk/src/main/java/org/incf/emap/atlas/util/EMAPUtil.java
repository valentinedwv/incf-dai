...
public class EMAPUtil {
	...
	public String getCoordinateTransformationChain(EMAPServiceVO vo, ComplexOutput co) {
		...
		try { 
			...
			EMAPUtil util = new EMAPUtil();
			EMAPServiceVO vo1 = new EMAPServiceVO();
			...
			} else if ( vo.getFromSRSCodeOne().equalsIgnoreCase(emap) && vo.getToSRSCodeOne().equalsIgnoreCase(whs10) ) {
	...
	public String getTransformationChain( EMAPServiceVO vo, ComplexOutput complexOutput, ArrayList srsCodeList ) { 
...
// 		    }
	...
	public String listTransformations( EMAPServiceVO vo, ComplexOutput complexOutput, ArrayList srsCodeList ) {
...
// 		    }
	...
	public String spaceTransformation( EMAPServiceVO vo ) {
...
/*		else if (fromSpace.trim().equalsIgnoreCase(abaReference) && toSpace.trim().equalsIgnoreCase(abaVoxel)) {
	...
	//FIXME - amemon - will eventually go to commons
	public String indirectSpaceTransformation( EMAPServiceVO vo ) {
	...
	//FIXME - amemon - will eventually go to commons
	public String getSpaceTransformationInfoXMLResponseString( EMAPServiceVO vo ) { 
...
*/
	...
	//FIXME - amemon - will eventually go to commons
	public String errorSpaceTransformationInfoXMLResponse( EMAPServiceVO vo ) { 
	...
	public EMAPServiceVO splitCoordinatesFromStringToVO(EMAPServiceVO vo, String completeCoordinatesString ) {
...
*/		vo.setTransformedCoordinateX(coordinateString[3]);
	...
	public String getFineStructureNameByPOI( EMAPServiceVO vo ) {
	...
	// http://132.239.131.188:8080/incf-services/service/wbc?request=GetFineStructureNameByPOI&atlasSpaceName=ABA&x=263&y=159&z=227
	public String getAnatomicStructureNameByPOI( EMAPServiceVO vo ) {
