...
//        System.out.println(root);
    ...
    public static void main(String[] args)throws Exception
    {
    	...
    	org.incf.ucsd.atlas.util.PostgresDBService.URL = "jdbc:postgresql://ceecee.ucsd.edu:5432/ccdbv2_2";
    	org.incf.ucsd.atlas.util.PostgresDBService.USERNAME = "ccdbd_dev";
