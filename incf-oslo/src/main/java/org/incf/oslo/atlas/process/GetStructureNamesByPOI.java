...
import org.incf.oslo.atlas.util.OsloServiceDAOImpl;
...
public class GetStructureNamesByPOI implements Processlet {
	...
	public void process(ProcessletInputs in, ProcessletOutputs out,
		...
		try {
			...
			// Convert the coordinates From any into ABAVOXEL
			...
			responseString = util.getStructureNameLookup(abaVoxel, vo.getTransformedCoordinateX(), vo.getTransformedCoordinateY(), vo.getTransformedCoordinateZ() );
			...
			OsloServiceDAOImpl impl = new OsloServiceDAOImpl();
			ArrayList list = impl.getStructureData();
			Iterator iterator = list.iterator();
			OsloServiceVO vo1 = null;
			String matchingStructureName = "";
			while (iterator.hasNext()) {
				vo1 = (OsloServiceVO) iterator.next();
