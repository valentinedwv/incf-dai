...
public class OsloUtil {
	...
	public String spaceTransformation( OsloServiceVO vo ) {
...
*/
	...
	public OsloServiceVO splitCoordinatesFromStringToVO(OsloServiceVO vo, String completeCoordinatesString ) {
...
*/		vo.setTransformedCoordinateX(coordinateString[3]);
	...
	try {
		...
		if ( atlasSpaceName.trim().equalsIgnoreCase(abaVoxel) ) { 
			...
			String transforMatrixURL = "http://tirebiter.ucsd.edu/cgi-bin/ratlookup.cgi?use_voxel=true&x=" + originalCoordinateX + "&y=" + originalCoordinateY + "&z=" + originalCoordinateZ;
			...
			if (transformedCoordinateString == null || transformedCoordinateString.equals("")) {
				...
				transformedCoordinateString = "No structure found";
			} else if (transformedCoordinateString.trim().equalsIgnoreCase("Nothing found")) {
				transformedCoordinateString = "No structure found";
			} else {
	...
	public String getCoordinateTransformationChain(OsloServiceVO vo, ComplexOutput co) {
		...
		try { 
			...
			OsloServiceVO vo1 = new OsloServiceVO();
	...
	public String getTransformationChain( OsloServiceVO vo, ComplexOutput complexOutput, ArrayList srsCodeList ) { 
		...
		try { 
	 			...
	 			i++;
	 			vo = (OsloServiceVO)iterator.next();
...
*/
	...
	public String listTransformations( OsloServiceVO vo, ComplexOutput complexOutput, ArrayList srsCodeList ) { 
