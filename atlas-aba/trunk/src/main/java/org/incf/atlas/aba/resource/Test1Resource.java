...
public class Test1Resource extends Resource {

	private final Logger logger = LoggerFactory.getLogger(Test1Resource.class);

	String message;

	public Test1Resource(Context context, Request request, Response response) {
	...
	public Representation represent(Variant variant) throws ResourceException {
		return new StringRepresentation("Test1Resource\n" + message);
	}
