 ...
 *
 */
public class EMAPServiceDAOImpl {

	private static final Logger LOG = 
			LoggerFactory.getLogger(EMAPServiceDAOImpl.class);

	private EMAPConfigurator configurator = EMAPConfigurator.INSTANCE;
	...
	public ArrayList getSliceData( EMAPServiceVO vo ) {
	...
	public ArrayList getAnnotationData(EMAPServiceVO vo, String polygonString) { 
		...
		Connection conn = dao.getStandAloneConnectionForEMAPHub();
		Statement stmt = conn.createStatement();
		StringBuffer query = new StringBuffer();
	...
	//Method override
	public ArrayList getAnnotationData(EMAPServiceVO vo) { 
