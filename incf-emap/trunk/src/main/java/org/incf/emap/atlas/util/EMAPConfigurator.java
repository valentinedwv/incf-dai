 ...
 * 
 */
public class EMAPConfigurator {

	/** Only public access to a single instance of this class */
	public static final EMAPConfigurator INSTANCE = new EMAPConfigurator();

	private static final Logger LOG = LoggerFactory
	.getLogger(EMAPConfigurator.class);
	...
	private InputStream getInputFileURL() {
		...
		"/prod-emap-config-properties.xml");
