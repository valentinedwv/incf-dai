...
import org.incf.oslo.atlas.process.ListTransformations;
 ...
 * 
 */
public class OsloConfigurator {

	/** Only public access to a single instance of this class */
	public static final OsloConfigurator INSTANCE = new OsloConfigurator();
	private static final Logger LOG = LoggerFactory
	.getLogger(OsloConfigurator.class);
