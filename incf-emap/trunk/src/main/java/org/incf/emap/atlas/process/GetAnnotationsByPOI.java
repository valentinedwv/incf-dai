...
import org.incf.emap.atlas.util.EMAPServiceDAOImpl;
import org.incf.emap.atlas.util.EMAPServiceVO;
import org.incf.emap.atlas.util.EMAPUtil;
...
*/
	...
	public AnnotationResponseDocument completeResponse(EMAPServiceVO vo) {
		...
		EMAPServiceDAOImpl daoImpl = new EMAPServiceDAOImpl();
		...
		while (iterator0.hasNext()) {
			vo = (EMAPServiceVO)iterator0.next(); 
			id = vo.getUniqueID();
...
*/
		...
		EMAPServiceVO vo2 = null; 

		//Delete this loop
		while (iterator1.hasNext()) {

			vo2 = (EMAPServiceVO)iterator1.next();
...
*/
	...
	EMAPServiceVO vo3 = null;
	while (iterator2.hasNext()) {

		vo3 = (EMAPServiceVO) iterator2.next();
	...
	EMAPServiceVO vo4 = null;

	while (iterator3.hasNext()) {
	
		vo4 = (EMAPServiceVO) iterator3.next();
