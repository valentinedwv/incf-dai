...
public class ServerApplication extends Application {
	...
	public Restlet createRoot() {
		...
		router.attach(TRANSFORM_POI_R, NotYetImplemented.class);
		
		router.attach(GET_TRANSFORMATION_CHAIN, NotYetImplemented.class);
		router.attach(GET_TRANSFORMATION_CHAIN_R, NotYetImplemented.class);
		
		router.attach(GET_2D_IMAGES_BY_POI, NotYetImplemented.class);
		router.attach(GET_2D_IMAGES_BY_POI_R, NotYetImplemented.class);
		...
		router.attach(GET_STRUCTURE_NAMES_BY_POI_R, NotYetImplemented.class);
